...
import com.buffetapp.pro.databinding.ActivityMenuRecyclerviewSnacksBinding
...
class MenuRecyclerviewSnacks : AppCompatActivity(), OnMenuListener {

    private lateinit var binding: ActivityMenuRecyclerviewSnacksBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //setContentView(R.layout.activity_menu_recyclerview_snacks)
        binding = ActivityMenuRecyclerviewSnacksBinding.inflate(layoutInflater)
    ...
    private fun fechaS(){
        ...
        val listener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                findViewById<TextView>(R.id.txtFechaS).text = "$data0"
            }
        ...
        val dataRef = database.child("Data").child("FechaSnack")
    ...
    private fun configRecyclerViewMenu() {
        ...
        binding.recyclerViewListSnack.apply {
            layoutManager = GridLayoutManager(this@MenuRecyclerviewSnacks, 1,
                GridLayoutManager.VERTICAL, false)
            adapter = this@MenuRecyclerviewSnacks.adapter
        }
    ...
    private fun configFirestoreListRealTime() {//Update en tiempo real//
        val db = FirebaseFirestore.getInstance()
        val menuRef = db.collection("antojitos")
