...
class ProfileFragment : Fragment() {
    ...
    private fun logic(){
        ...
        if (account != null) {
            ...
            val imageView = view?.findViewById<ImageView>(R.id.image_user)
            ...
            val name_profile= view?.findViewById<TextView>(R.id.name_profile)
            name_profile?.text = personName
            val email_profile = view?.findViewById<TextView>(R.id.email_profile)
